...
import com.example.appeventosteste.activities.TechSessionsActivity;

public class TSessions extends Item {
	...
	public void starctActivity(Context context) {
		...
		Intent intent = new Intent(context,TechSessionsActivity.class);

...
public class ParseTechSessionsMain {
	private static TSessionsProgram programacaoTechSessions;
	...
	public static TSessionsProgram parse(Context context, String xmlFile) throws IOException, SAXException {
		
		final RootElement root = new RootElement("techsessions");
		
		programacaoTechSessions = new TSessionsProgram();

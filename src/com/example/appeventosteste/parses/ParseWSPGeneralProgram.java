...
import com.example.appeventosteste.beans.GeneralProgram;
...
public class ParseWSPGeneralProgram {
	...
	private static GeneralProgram programacaoGeral;
	...
	public static GeneralProgram  parse(Context context, String xmlFile) throws IOException, SAXException {
		
		programacaoGeral = new GeneralProgram();
